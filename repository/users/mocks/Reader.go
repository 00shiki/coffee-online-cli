...
func (_m *Reader) CheckEmailExists(email string) error {
	ret := _m.Called(email)
...
func (_m *Reader) GetUserByEmail(email string) (*entity.User, error) {
	ret := _m.Called(email)
...
func (_m *Reader) GetUserByID(id int) (*entity.User, error) {
	ret := _m.Called(id)
...
func (_m *Reader) LoyalCustomer() ([]entity.UserLoyal, error) {
	ret := _m.Called()
