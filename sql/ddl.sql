...
CREATE TABLE Product (
  ...
  UpdatedAt TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP -- Timestamp when the product was last updated
);
...
CREATE TABLE Users (
  ...
  Password CHAR(60) NOT NULL,                -- Hashed password of the user
...
CREATE TABLE Payments (
  ...
  PaymentDate TIMESTAMP DEFAULT CURRENT_TIMESTAMP -- Date and time of the payment
);
